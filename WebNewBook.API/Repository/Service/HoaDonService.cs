    ...
    public class HoaDonService : IHoaDonService
    {
        ...
        public async Task SendMailOder(string idHoaDon)
        {
            ...
            if (hoaDon.MaGiamGia != null)
            {
                ...
                textVoucher = "<tr> <td style=\\\"line-height: 20px; font-size: 16px; width: 100%; margin: 0; padding: 7px; MARGIN-LEFT: 68px !important; display: flex; align-items: end; justify-content: end;\\\"\\\">Mã giảm giá: #\" + voucher.Id +\"\" + voucher.MenhGia.ToString(\"#,##0\").Replace(',', '.') + \"đ </td></tr> ";
            }
