...
namespace WebNewBook.API.Repository.Service
{
    public class HoaDonService : IHoaDonService
    {
        ...
        public async Task SendMailOder(string idHoaDon)
        {
            ...
            {
                strings.Add("<tr> <td style=\" line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px; \" align=\"left\" width=\"100%\" >" + item.SanPham.TenSanPham + "" + "(" + item.SoLuong + ")</td> <td class=\"text-right\" style=\" line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px; \" align=\"right\" width=\"100%\" > " + item.GiaBan.ToString("#,##0").Replace(',', '.') + "đ </td> </tr>");
            }
            ...
            smtp.Authenticate("phonglvph16158@fpt.edu.vn", "Nhập mật khẩu ợ đẫy");
            smtp.Send(email);
