...
builder.Services.AddDbContext<dbcontext>(option => option.UseSqlServer("Data Source=ADMIN\\SQLEXPRESS;Initial Catalog=ProjectBookFPT;Persist Security Info=True;User ID=anhld15409;Password=Anh02012002"));
